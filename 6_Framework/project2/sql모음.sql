...
SELECT * FROM BOARD WHERE BOARD_NO = 2003;
...
SELECT LEVEL, CONNECT_BY_ISLEAF AS CHILD_CHECK, C.* FROM
	(SELECT COMMENT_NO, ROOT_COMMENT_NO, COMMENT_DEL_FL, COMMENT_CONTENT, PARENT_NO,
		TO_CHAR(C_CREATE_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') C_CREATE_DATE,
	BOARD_NO, MEMBER_NO, MEMBER_NICKNAME, PROFILE_IMG 
	FROM "COMMENT" C2
	JOIN MEMBER USING(MEMBER_NO)
	WHERE BOARD_NO = 1978
	AND (SELECT COUNT(*) FROM "COMMENT" C3
	WHERE C3.ROOT_COMMENT_NO = C2.ROOT_COMMENT_NO
	AND COMMENT_DEL_FL = 'N') > 0
	) C
...
WHERE COMMENT_NO = 2045;
--WHERE ROOT_COMMENT_NO = 2038;
COMMIT;

-- 컬럼 추가
ALTER TABLE "COMMENT"
ADD ROOT_COMMENT_NO NUMBER;

-- 제약조건 추가
ALTER TABLE "COMMENT"
ADD FOREIGN KEY(ROOT_COMMENT_NO) REFERENCES "COMMENT";

-- 최상위 부모
-- 2038
INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모1', DEFAULT, DEFAULT,  1978, 10, NULL, SEQ_COMMENT_NO.CURRVAL); 
-- 2039
INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모2', DEFAULT, DEFAULT,  1978, 10, NULL, SEQ_COMMENT_NO.CURRVAL); 

-- 자식
INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모1-자식1', DEFAULT, DEFAULT,  1978, 10, 2038, 2038); -- 2040
INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모1-자식2', DEFAULT, DEFAULT,  1978, 10, 2038, 2038); -- 2041
INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모1-자식3', DEFAULT, DEFAULT,  1978, 10, 2038, 2038); -- 2042

INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모2-자식1', DEFAULT, DEFAULT,  1978, 10, 2039, 2039); -- 2043
INSERT INTO "COMMENT" VALUES( 
SEQ_COMMENT_NO.NEXTVAL,'부모2-자식2', DEFAULT, DEFAULT,  1978, 10, 2039, 2039); -- 2044

-- 손자
INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모1-자식1-손자1', DEFAULT, DEFAULT,  1978, 10, 2040, 2038);
INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모1-자식1-손자2', DEFAULT, DEFAULT,  1978, 10, 2040, 2038);


INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모2-자식1-손자1', DEFAULT, DEFAULT,  1978, 10, 2043, 2039);
INSERT INTO "COMMENT" VALUES(
SEQ_COMMENT_NO.NEXTVAL,'부모2-자식1-손자2', DEFAULT, DEFAULT,  1978, 10, 2043, 2039);
...
UPDATE "COMMENT" SET ROOT_COMMENT_NO = 2038
WHERE COMMENT_NO = 2046;

SELECT * FROM "COMMENT" WHERE BOARD_NO = 1978;

SELECT COUNT(*) FROM "COMMENT"
WHERE ROOT_COMMENT_NO = 2038
AND COMMENT_DEL_FL = 'Y';
